                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="app_nama" id="app_nama" value="{{ $appData->app_nama }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="app_desc" id="app_desc" value="{{ $appData->app_desc }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                            ...
                                                            value="{{ $appData->app_author }}" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                            ...
                                                            value="{{ $appData->app_email }}" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="app_tlp" id="app_tlp" value="{{ $appData->app_tlp }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                            ...
                                                            value="{{ $appData->app_alamat }}" required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <form class="row" method="POST"
                                                    ...
                                                    <div class="col-md-12 mb-3 text-center"
                                                        ...
                                                        <img src="{{ asset($appData->app_logo_w) }}" style="width: 80%">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <form class="row" method="POST"
                                                    ...
                                                    <div class="col-md-12 mb-3 text-center" style="min-height: 100px;">
                                                        <img src="{{ asset($appData->app_icon) }}" style="width: 25%">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
