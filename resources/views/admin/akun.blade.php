            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card border-left-1">
                        <div class="card-header">
                            <h5><i class="icofont icofont-cube text-primary"></i> Akun</h5>
                            <hr>
                        ...
                        <div class="card-block">
                            <form id="form-akun" action="{{ route('admin.akun.update') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="" class="req">Username</label>
                                            <input type="text" class="form-control form-control-sm" name="user_username"
                                                id="user_username" value="{{ $akun->user_username }}" readonly required>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="req">Nama</label>
                                            <input type="text" class="form-control form-control-sm" name="user_nama"
                                                id="user_nama" value="{{ $akun->user_nama }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="req">Email</label>
                                            <input type="text" class="form-control form-control-sm" name="user_email"
                                                id="user_email" value="{{ $akun->user_email }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="req">No Telepon</label>
                                            <input type="text" class="form-control form-control-sm" name="user_tlp"
                                                id="user_tlp" value="{{ $akun->user_tlp }}" required>
                                        </div>
                                    </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form id="form-pass" action="{{ route('admin.akun.updatePass') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
