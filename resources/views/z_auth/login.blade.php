...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{ asset($appData->app_icon ?? 'komponen/login/images/favicon.png') }}" type="image/x-icon">
                            ...
                            <div class="col-md-12 text-center">
                                <div class="card-body">
                                    <div class="brand-wrapper">
                                        <img src="{{ asset($appData->app_logo ?? 'komponen/login/images/logo.png') }}" alt="logo" class=""
                                            style="width: 270px">
                                    </div>
