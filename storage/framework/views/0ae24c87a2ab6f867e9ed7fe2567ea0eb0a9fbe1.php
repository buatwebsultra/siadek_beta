...
<?php $__env->startSection('pageName', 'Pembayaran SPP'); ?>
<?php $__env->startSection('body'); ?>
    ...
    <div class="modal fade" id="modal_sync" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <form id="form-sync" action="<?php echo e(route('admin.mhs-status.sync')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-content border-top-1">
                    <div class="modal-header">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sync_ta" id="sync_ta" required>
                                        ...
                                        <?php $__currentLoopData = $tas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ta1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($ta1->ta_kode); ?>">📆 <?php echo e($ta1->ta_kode); ?></option>
    ...
    <div class="modal fade" id="modal_laporan" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <form id="form-laporan" action="<?php echo e(route('admin.laporan.ukt')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="lap_jur_id" id="lap_jur_id" required>
                                        ...
                                        <?php $__currentLoopData = $jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($jur->jur_id); ?>">
                                                <?php echo e($jur->jur_nama); ?> - (<?php echo e($jur->jur_jenjang); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
    ...
    <form id="form-valid" action="<?php echo e(route('admin.ukt.validasi')); ?>" method="POST">
        <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $('#tbl1').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('data.pembayaran-ukt')); ?>/" + localJurusan,
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        searchable: false,
        ...
        async function initValidasi(file, id) {
            $('#byr_idx').val(id);
            let res = await sendAjax("<?php echo e(route('data.pembayaran.detail')); ?>/" + id, {}, 'GET');
            if (res.status) {
                isiData(res.data);
            } else {
                alertError(res.msg);
...
<?php echo $__env->make('_layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\siadek_beta\resources\views/admin/ukt_data.blade.php ENDPATH**/ ?>