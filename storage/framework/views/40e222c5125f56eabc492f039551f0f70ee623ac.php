...
<?php $__env->startSection('pageName', 'Mahasiswa'); ?>
<?php $__env->startSection('body'); ?>
                                ...
                                <?php if($guard == 'admin'): ?>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php echo $__env->make('_komponen.form_pilih_jurusan', $jurusan, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="mhs_status" id="mhs_status" required>
                                        <option value="">-- Pilih --</option>
                                        <?php $__currentLoopData = $stsMahasiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key5 => $val5): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key5); ?>"><?php echo e($val5); ?> </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="mhs_agama" id="mhs_agama"
                                        ...
                                        <?php $__currentLoopData = $agama; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($agm->agm_nama); ?>"><?php echo e($agm->agm_nama); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="modal_reset_nilai" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content border-top-1">
                <form id="form-reset-nilai" action="<?php echo e(route('pro.penilaian.reset')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="modal_export" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form id="form-export" action="<?php echo e(route('pro.mahasiswa.export-data')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
    ...
    <form id="form-buka-data-mhs" method="POST" action="<?php echo e(route('admin.mahasiswa.buka.data-diri')); ?>">
        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        <?php else: ?>
            ...
            localJurusanID = '<?php echo e($kaprodi->ds_jur_id); ?>';
        <?php endif; ?>
        ...
        function initTable() {
            $('#tbl1').DataTable({
                ...
                processing: true,
                serverSide: false,
                ajax: "<?php echo e(route('data.mahasiswa')); ?>/" + localJurusanID,
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        searchable: false
        ...
        function initCariDosen() {
            $('#mhs_dosen_id').select2({
                ...
                dropdownParent: $("#modal_add"),
                ajax: {
                    url: "<?php echo e(route('pro.dosen.cari')); ?>/" + localJurusanID,
                    dataType: 'json',
                    delay: 250,
        ...
        function initAdd() {
            ...
            $('#form-mhs').attr('action', "<?php echo e(route('admin.mahasiswa.create')); ?>");
        ...
        async function initEdit(id) {
            ...
            $('#form-mhs').trigger('reset');
            $('#form-mhs').attr('action', "<?php echo e(route('admin.mahasiswa.update')); ?>");
            let res = await sendAjax("<?php echo e(route('admin.mahasiswa.get')); ?>/" + id, {}, 'GET');
            if (res.status) {
                isiData(res.data);
                $('#modal_add').modal('show');
            } else {
        ...
        async function deleteMhs(idx) {
            let res = await sendAjax("<?php echo e(route('admin.mahasiswa.delete')); ?>", {
                id: idx
            });
            if (res.status) {
                $('#tbl1').DataTable().ajax.reload();
        ...
        async function initReset(idx) {
            let res = await sendAjax("<?php echo e(route('admin.mahasiswa.reset')); ?>", {
                id: idx
            });
            if (res.status) {
                alertSuccess(res.msg);
...
<?php echo $__env->make('_layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\siadek_beta\resources\views/admin/mahasiswa.blade.php ENDPATH**/ ?>