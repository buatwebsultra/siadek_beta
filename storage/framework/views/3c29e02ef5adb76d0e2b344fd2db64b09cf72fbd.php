...
<?php $__env->startSection('pageName', 'Akun'); ?>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form id="form-pass" action="<?php echo e(route('lecturer.akun.updatePass')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-md-12">
...
<?php echo $__env->make('_layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\siadek_beta\resources\views/dosen/akun.blade.php ENDPATH**/ ?>