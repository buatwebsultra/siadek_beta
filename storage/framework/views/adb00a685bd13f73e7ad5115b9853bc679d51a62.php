...
<?php $__env->startSection('pageName', 'Dosen/Pengajar'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="col-sm-12 select2" name="ds_jur_id" id="ds_jur_id" required>
                                        ...
                                        <?php else: ?>
                                            <option value="<?php echo e($dosen->jurusan->jur_id); ?>"><?php echo e($dosen->jurusan->jur_nama); ?> -
                                                (<?php echo e($dosen->jurusan->jur_jenjang); ?>)
                                            </option>
                                        <?php endif; ?>
                                    </select>
                                </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        <?php else: ?>
            ...
            localJurusanID = '<?php echo e($dosen->ds_jur_id); ?>';
        <?php endif; ?>
        ...
        function initDataTable() {
            $('#tbl1').DataTable({
                ...
                processing: true,
                serverSide: false,
                ajax: "<?php echo e(route('data.dosen')); ?>/" + localJurusanID,
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        searchable: false
        ...
        function initAdd() {
            ...
            $('#form-ds').attr('action', "<?php echo e(route('admin.dosen.create')); ?>");
        ...
        async function initEdit(id) {
            ...
            $('#form-ds').trigger('reset');
            $('#form-ds').attr('action', "<?php echo e(route('admin.dosen.update')); ?>");
            let res = await sendAjax("<?php echo e(route('admin.dosen.get')); ?>/" + id, {}, 'GET');
            if (res.status) {
                isiData(res.data);
                $('#modal_add').modal('show');
            } else {
        ...
        async function deleteDosen(idx) {
            let res = await sendAjax("<?php echo e(route('admin.dosen.delete')); ?>", {
                id: idx
            });
            if (res.status) {
                $('#tbl1').DataTable().ajax.reload();
        ...
        async function initReset(idx) {
            let res = await sendAjax("<?php echo e(route('admin.dosen.reset')); ?>", {
                id: idx
            });
            if (res.status) {
                alertSuccess(res.msg);
        ...
        function initBimbingan(idds) {
            document.location = "<?php echo e(route('admin.dosen.unduh.mhs-akademik')); ?>?idds="+idds;
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('_layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\siadek_beta\resources\views/admin/pengajar.blade.php ENDPATH**/ ?>