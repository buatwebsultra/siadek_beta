...
<?php $__env->startSection('pageName', 'Mata Kuliah'); ?>
                ...
                <div class="col-sm-12">
                    <div class="card b-l-info">
                        <div class="card-header">
                            ...
                            <?php if(@$isKaprodi): ?>
                                <span><?php echo e($jurusan[0]->jur_nama); ?> (<?php echo e($jurusan[0]->jur_jenjang); ?>)</span>
                            <?php endif; ?>
                            <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="col-sm-12 select2" name="matkul_ruang_id" id="matkul_ruang_id"
                                        ...
                                        <?php $__currentLoopData = $ruangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($ruang->ruang_id); ?>"><?php echo e($ruang->ruang_nama); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="col-sm-12 select2" name="matkul_dosen1" id="matkul_dosen_id1"
                                        required>
                                        <option value="">-- Pilih --</option>
                                        <?php $__currentLoopData = $dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($ds->ds_id); ?>">
                                                <?php echo e($ds->ds_nama . ', ' . $ds->ds_gelar); ?> (<?php echo e($ds->ds_nip); ?>) ➡️
                                                <?php echo e($ds->jurusan->jur_nama); ?> (<?php echo e($ds->jurusan->jur_jenjang); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control form-control-sm"
                                        value="<?php echo e(date('H:i')); ?>" name="matkul_jadwal" id="matkul_jadwal" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control form-control-sm"
                                        value="<?php echo e(date('H:i')); ?>" name="matkul_end" id="matkul_end" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $('#tbl1').DataTable({
                ...
                processing: true,
                serverSide: false,
                ajax: "<?php echo e(route('data.matkul')); ?>/" + localJurusanID,
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        searchable: false
        ...
        function initAdd() {
            ...
            $('#form-matkul').attr('action', "<?php echo e(route('admin.matkul.create')); ?>");
        ...
        async function initEdit(id) {
            ...
            $('#form-matkul').trigger('reset');
            $('#form-matkul').attr('action', "<?php echo e(route('admin.matkul.update')); ?>");
            let res = await sendAjax("<?php echo e(route('admin.matkul.get')); ?>/" + id, {}, 'GET');
            if (res.status) {
                isiData(res.data);
                $('#modal_add').modal('show');
            } else {
        ...
        async function deleteMatkul(idx) {
            let res = await sendAjax("<?php echo e(route('admin.matkul.delete')); ?>", {
                id: idx
            });
            if (res.status) {
                $('#tbl1').DataTable().ajax.reload();
...
<?php echo $__env->make('_layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\siadek_beta\resources\views/admin/matkul.blade.php ENDPATH**/ ?>